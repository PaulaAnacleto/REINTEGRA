...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="../Templates/css/inicial-login.css">
</head>
<body>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
  <div class="container">
    ...
    <!-- Nova Seção: Você está no caminho certo -->
    <section class="caminho-certo-section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <h2 class="caminho-title">Você está no caminho certo!</h2>
                    <h2 class="caminho-subtitle">Vamos <span class="text-primary">conquistar</span> mais juntos.</h2>
                    <p class="caminho-text mt-4">Desfrute de vários <span class="text-primary fw-bold">serviços</span> agora mesmo !</p>
                    <button class="btn btn-servicos mt-3" type="button">Serviços</button>
                </div>
    ...
    <!-- Nova Seção: Feedback Form -->
    <section id="cadastro" class="feedback-form-section">
        <div class="container">
            <h2 class="section-title text-center mb-5">Feedback</h2>
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8">
                    <div class="feedback-form-container">
                        <input type="text" class="form-control feedback-input" placeholder="Adicione um Feedback">
                        <button class="btn btn-feedback-submit" type="button">
